defmodule Noncegeek.Import.Stage do
  @moduledoc """
  ...
  alias Ecto.Multi
  alias Noncegeek.Explorer.Import.Runner

  @typedoc """
  Maps `t:Noncegeek.Import.Import.Runner.t/0` callback module to the `t:Noncegeek.Import.Import.Runner.changes_list/0` it
  can import.
  """
  ...
  @doc """
  Uses a single `t:Noncegeek.Import.Runner.t/0` and chunks the `changes_list` across multiple `t:Ecto.Multi.t/0`
  """
