defmodule NoncegeekWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: NoncegeekWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/noncegeek_web/templates",
        namespace: NoncegeekWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {NoncegeekWeb.LayoutView, "live.html"}
